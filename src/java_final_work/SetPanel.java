...
public class SetPanel extends JPanel implements ItemListener, ChangeListener, ActionListener{
		...
		private	JPanel temp0=new JPanel(new GridLayout(4,1)), temp1=new JPanel(new FlowLayout(FlowLayout.LEFT)), temp2=new JPanel(new FlowLayout 
(FlowLayout.LEFT)), temp3=new JPanel(new FlowLayout(FlowLayout.LEFT)), temp4=new JPanel(new FlowLayout(FlowLayout.LEFT)), temp5=new JPanel(new FlowLayout 
(FlowLayout.LEFT)), temp6=new JPanel(new FlowLayout(FlowLayout.LEFT)), temp7=new JPanel(new FlowLayout(FlowLayout.LEFT)), temp8=new JPanel(new GridLayout 
(3,1));
		...
		public SetPanel(){//产生版面//
			...
			pie_remove_ctrl();
			Painter.stroke = new BasicStroke(5, BasicStroke.CAP_ROUND, BasicStroke.JOIN_MITER);
		}
		...
		public void actionPerformed( ActionEvent e ){
			...
			if ( e.getSource() == style[0] )
				Painter.stroke = new BasicStroke( stroke2.getLineWidth(), BasicStroke.CAP_ROUND, stroke2.getLineJoin(), stroke2.getMiterLimit(),  
stroke2.getDashArray(), stroke2.getDashPhase() );
			else if ( e.getSource() == style[1] )
				Painter.stroke = new BasicStroke( stroke2.getLineWidth(), BasicStroke.CAP_BUTT, stroke2.getLineJoin(), stroke2.getMiterLimit(),  
stroke2.getDashArray(), stroke2.getDashPhase() );
		...
		public void stateChanged(ChangeEvent e){
        	...
        	BasicStroke stroke2 = (BasicStroke) Painter.stroke;
        	Painter.stroke = new BasicStroke( number, stroke2.getEndCap(), stroke2.getLineJoin(), stroke2.getMiterLimit(), stroke2.getDashArray(),  
